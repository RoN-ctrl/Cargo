...
//        Link getByAccount = linkTo(methodOn(ParcelController.class)
//                .getParcelsByAccountId(entity.getAccount().getId())).withRel("get");
        ...
        parcelModel.add(create, getById/*, getByAccount*/, getByStatus, update, deleteByID);
